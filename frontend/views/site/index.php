        ...
        <?php foreach ($data as $item) { ?>
            <div class="col-md-4" style="margin-bottom: 20px;">
                <div class="card" style="border: 1px solid #6c757d; padding: 10px;">
                    <img src="<?= '../../../../toko/backend/web/'.$item->image ?>" alt="<?= $item->name ?>" class="card-img-top img-reponsive img-rounded" height="250px" width="100%">
                    ...
                    <div class="card-footer" style="margin-top: 10px;">
                        ...
                        <div class="" style="display: flex; flex-wrap: wrap; justify-content: center; align-items: center;">
                            <a href="https://api.whatsapp.com/send?phone=6289529240209" class="btn btn-primary">Buy</a>
                        </div>
                    </div>
                    <?php } ?>
                </div>
